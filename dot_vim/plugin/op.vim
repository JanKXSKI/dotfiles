...
let s:source = "'ag -cU <f-args>'"
let s:preview = "'~/.sh/agprev {1} $FZF_PREVIEW_LABEL $FZF_PREVIEW_LINES <f-args>'"
let s:bind = "'--bind', 'ctrl-n:transform-preview-label(bash -c \"~/.sh/agwrap $FZF_PREVIEW_LABEL {2}\")+refresh-preview,focus:change-preview-label(1)'"
let s:options = "['-d', ':', '--nth', '1', '--preview', "..s:preview..", "..s:bind.."]"
